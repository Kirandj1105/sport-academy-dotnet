    ...
    public class PaymentService : IPaymentService
    {
        public Task<MerchantOrder> ProcessMerchantOrder(PaymentRequest payRequest)
        {
            try
            {
                ...
                Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_Qmitj2jnYiBG3p", "cNIOwxrZSlD79tRMooZ9FaXw");
                ...
                MerchantOrder order = new MerchantOrder
                {
                    ...
                    RazorpayKey = "rzp_test_Qmitj2jnYiBG3p",
